...
<script lang="ts" setup>
  ...
  import { getChannelList, deleteChannel, batchDeleteChannel } from './channel.api';
  ...
  function handleDelete(record) { deleteChannel({ id: record.id }, reload); }
  function batchHandleDelete() {
    batchDeleteChannel({ ids: selectedRowKeys.value.join(',') }, () => {
