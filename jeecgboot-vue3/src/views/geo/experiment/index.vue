<template>
  <div>
    ...
    <ExperimentModal @register="registerModal" @success="reload" />
  </div>
</template>
...
<script lang="ts" setup>
  ...
  import { columns, searchFormSchema } from './experiment.data';
  import { getExperimentList, deleteExperiment, batchDeleteExperiment } from './experiment.api';
  ...
  function handleDelete(record) { deleteExperiment({ id: record.id }, reload); }
  function batchHandleDelete() {
    batchDeleteExperiment({ ids: selectedRowKeys.value.join(',') }, () => {
