...
<script lang="ts" setup>
  ...
  import { getMerchantList, deleteMerchant, batchDeleteMerchant } from './merchant.api';
  ...
  function handleDelete(record) {
    deleteMerchant({ id: record.id }, reload);
  }

  function batchHandleDelete() {
    batchDeleteMerchant({ ids: selectedRowKeys.value.join(',') }, () => {
