<template>
  <div>
    ...
    <MentionModal @register="registerModal" @success="reload" />
  </div>
</template>
...
<script lang="ts" setup>
  ...
  import { columns, searchFormSchema } from './mention.data';
  import { getMentionList, deleteMention, batchDeleteMention } from './mention.api';
  ...
  function handleDelete(record) { deleteMention({ id: record.id }, reload); }
  function batchHandleDelete() {
    batchDeleteMention({ ids: selectedRowKeys.value.join(',') }, () => {
