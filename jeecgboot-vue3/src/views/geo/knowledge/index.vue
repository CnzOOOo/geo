...
<script lang="ts" setup>
  ...
  import { getKnowledgeList, deleteKnowledge, batchDeleteKnowledge } from './knowledge.api';
  ...
  function handleDelete(record) { deleteKnowledge({ id: record.id }, reload); }
  function batchHandleDelete() {
    batchDeleteKnowledge({ ids: selectedRowKeys.value.join(',') }, () => {
